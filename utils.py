...
class TimeWindowChecker:
    ...
    def get_current_device_config(self, device_name, device_configs, hass: HomeAssistant = None):
        ...
        for config in device_configs:
            ...
            try:
                ...
                matched = False
                if start_time <= end_time:
                    matched = start_time <= now <= end_time
                else:
                    matched = now >= start_time or now <= end_time
